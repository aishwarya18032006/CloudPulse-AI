/**
 * Dashboard metrics builder for simulator-generated demo data.
 * Production: fed by AWS / Azure / GCP API collectors instead of manual forms.
 */
...
export function buildDashboardMetrics(inputs, prediction, recommendations = null) {
